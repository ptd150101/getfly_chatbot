        ...
        if message.lower().strip() in RESTART_KEYWORDS:
            ...
            try:
                ...
                return True, {
                    ...
                    "message": f'Webhook restart chat processed for thread_id: {communi_thread_id}'
                    }
            finally:
                db.close()
        ...
        try:
            ...
            try:
                ...
                return True, {
                    ...
                    "message": f'Webhook processed for thread_id: {communi_thread_id}'
                }
        ...
        if "body" in json_data and "postback" in json_data["body"]:
            ...
            if postback == "connect_cs_team":
                try:
                    ...
                    return {
                        "message": "Failed to connect to CSKH"
                    }
        ...
        if "metadata" in json_data.get("body", {}) and json_data["body"]["metadata"]:
            ...
            if message:
                ...
                return {
                    ...
                    "message": "Image received, but no text to process."
                }
